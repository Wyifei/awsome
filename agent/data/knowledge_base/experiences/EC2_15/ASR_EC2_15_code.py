"""
修复方案: EC2 子网不应自动分配公共 IP
Control ID: EC2.15
Source: AWS Automated Security Response (ASR)
Generated: 2026-01-29T05:45:46.470368Z
...
def remediate(resource_id: str, **kwargs) -> dict:
    ...
    # SSM Document: ASR-DisablePublicIPAutoAssign
    ...
    try:
        ...
        return {
            "success": True,
            "message": f"Successfully remediated {resource_id} for EC2.15"
        }
