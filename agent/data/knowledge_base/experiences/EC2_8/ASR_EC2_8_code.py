"""
修复方案: EC2 实例应使用 IMDSv2
Control ID: EC2.8
Source: AWS Automated Security Response (ASR)
Generated: 2026-01-29T05:45:46.516880Z
...
def remediate(resource_id: str, **kwargs) -> dict:
    ...
    # SSM Document: ASR-EnableIMDSV2OnInstance
    ...
    try:
        ...
        return {
            "success": True,
            "message": f"Successfully remediated {resource_id} for EC2.8"
        }
